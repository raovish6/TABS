...
parser.add_argument('--protocol', default='SALD', type=str)
...
if __name__ == '__main__':
    ...
    load_dir = args.root + '/' + 'dlbs' + '/best_model_TABS_x8.pth'
    ...
    log_name = os.path.join(args.root, args.protocol, 'crosstest_SALD.txt')
